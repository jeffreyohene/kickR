#' Scrape Liga MX team statistics from FBRef.com
#'
#' This function scrapes team statistics for Liga MX from FBRef.com for a
#' specific season and data type.
#'
#' @name fbref_liga_mx_team_stats
#'
#' @param season The season to retrieve statistics for (e.g., "2022/2023").
#' If not provided, the current season will be used.
#' @param type The type of statistics to retrieve (e.g., "standard"). If not
#' provided, "standard" will be used.
#'
...
fbref_liga_mx_team_stats <- function(season = NULL, type = NULL) {
  code <- 31
  league_stats <- 'Liga-MX-Stats'
