#' Scrape Portuguese Primeira Liga Team Statistics from FBref
#'
#' This function scrapes team statistics for the Primeira Liga from FBref.com.
#'
#' @name fbref_primeira_liga_team_stats
#'
#' @param season The season you want to retrieve statistics for. If not provided,
#'                the function
#'              defaults to the current season.
#' @param type The type of statistics to retrieve. Options include "standard,"
#'              "goalkeeping,"
...
fbref_primeira_liga_team_stats <- function(season = NULL, type = NULL) {

  code <- 32
  league_stats <- 'Primeira-Liga-Stats'
