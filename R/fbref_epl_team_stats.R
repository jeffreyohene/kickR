#' Retrieve English Premier League team statistics from FBref.
#'
#' This function scrapes team statistics for the English Premier League from FBref.com.
#' @name fbref_epl_team_stats
#' @param season A character string representing the season (e.g., "2022/2023").
#' If NULL, the current season is used.
#' @param type A character string representing the type of statistics to
#' retrieve (e.g., "standard"). Default is "standard."
#'
#' @return A data frame containing the requested team statistics.
#'
#' @details This function fetches English Premier League team statistics from
#' FBref based on the provided season and type.
...
fbref_epl_team_stats <- function(season = NULL, type = NULL) {

  code <- 9
  league_stats <- 'Premier-League-Stats'
