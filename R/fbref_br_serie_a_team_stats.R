#' Scrape Campeonato Brasileiro Série A Team Statistics from FBref
#'
#' This function scrapes team statistics for Serie A from FBref based on the
#' season and type provided.
#'
#' @name fbref_br_serie_a_team_stats
#'
#' @param season A string specifying the season in the format "YYYY/YYYY" or
#' "YY/YY". If not provided, it defaults to the current season.
#' @param type A string specifying the type of statistics to retrieve (e.g.,
#' "standard", "goalkeeping", "shooting"). If not provided, it defaults
#' to "standard".
#'
...
fbref_br_serie_a_team_stats <- function(season = NULL, type = NULL) {
  code <- 24
