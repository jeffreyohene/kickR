#' Fetch Bundesliga team statistics data from FBRef
#'
#' This function fetches Bundesliga team statistics data from FBRef for a specified season and data type.
#' @name fbref_2bundesliga_team_stats
#' @param season A character string representing the season in the format "YYYY/YYYY" or "YY/YY" (e.g., "2022/2023" or "22/23").
#' @param type A character string specifying the type of statistics to retrieve. Possible values include "standard," "goalkeeping," "advanced_goalkeeping," "shooting," "passing," "pass_types," "goal_creation," "defensive_actions," "possession," "playing_time," and "miscellaneous."
#'
...
fbref_2bundesliga_team_stats <- function(season = NULL, type = NULL) {
  code <- 33
  ...
  if (is.null(normalized_season)) {
    message('Check season provided input.')
    return(NULL)
  }
