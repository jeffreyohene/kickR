#' Scrape French Ligue 2 Team Statistics from FBref
#'
#' This function scrapes team statistics for Ligue 2 from FBref.com.
#'
#' @name fbref_ligue2_team_stats
#'
#' @param season The season you want to retrieve statistics for. If not provided, the function
#'              defaults to the current season.
#' @param type The type of statistics to retrieve. Options include "standard," "goalkeeping,"
#'             "advanced_goalkeeping," "shooting," "passing," "pass_types," "goal_creation,"
#'             "defensive_actions," "possession," "playing_time," and "miscellaneous."
#'
#' @return A data frame containing the requested team statistics for the specified season and type.
#'
...
fbref_ligue2_team_stats <- function(season = NULL, type = NULL) {
  code <- 60
  league_stats <- 'Ligue-2-Stats'
