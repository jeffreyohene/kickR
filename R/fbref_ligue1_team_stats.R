#' Scrape French Ligue 1 Team Statistics from FBref
#'
#' This function scrapes team statistics for Ligue 1 from FBref.com.
#'
#' @name fbref_ligue1_team_stats
#'
...
fbref_ligue1_team_stats <- function(season = NULL, type = NULL) {
  code <- 13
  league_stats <- 'Ligue-1-Stats'
